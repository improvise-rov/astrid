...
ADDRESS_ESC_MOTOR_FRONT_LEFT: int   = 8
ADDRESS_ESC_MOTOR_FRONT_RIGHT: int  = 4
ADDRESS_ESC_MOTOR_BACK_LEFT: int    = 6
ADDRESS_ESC_MOTOR_BACK_RIGHT: int   = 7
ADDRESS_ESC_MOTOR_TOP_LEFT: int     = 5
ADDRESS_ESC_MOTOR_TOP_RIGHT: int    = 9
