...
ADDRESS_ESC_MOTOR_FRONT_LEFT: int   = 9 # i cant tell which is which for these. trial by fire
ADDRESS_ESC_MOTOR_FRONT_RIGHT: int  = 8
ADDRESS_ESC_MOTOR_BACK_LEFT: int    = 7
ADDRESS_ESC_MOTOR_BACK_RIGHT: int   = 6
ADDRESS_ESC_MOTOR_TOP_LEFT: int     = 5
ADDRESS_ESC_MOTOR_TOP_RIGHT: int    = 4
