...
class Rov():
    ...
    def tick(self, dt: float):
        ...
        self.hardware.set_servo('tool_ver',   int(self.net_motor_cache['tool_ver']), camera = False) # the tool gripper only actually needs to go 0..90, so i divide the range by 2 (because its transmitted as a number 0..180)
