...
ADDRESS_ESC_MOTOR_FRONT_LEFT: int   = 4
ADDRESS_ESC_MOTOR_FRONT_RIGHT: int  = 9
ADDRESS_ESC_MOTOR_BACK_LEFT: int    = 5
ADDRESS_ESC_MOTOR_BACK_RIGHT: int   = 8
ADDRESS_ESC_MOTOR_TOP_LEFT: int     = 6
ADDRESS_ESC_MOTOR_TOP_RIGHT: int    = 7
ADDRESS_SERVO_TOOL_VER: int       = 0
ADDRESS_SERVO_TOOL_HOR: int        = 1
...
# byte quantities
ESC_BYTE_MOTOR_SPEED_MIN: int = 0
ESC_BYTE_MOTOR_SPEED_MID: int = 127
ESC_BYTE_MOTOR_SPEED_MAX: int = 255
...
PWM_BLUEROBOTICS_ESC_REVERSE: int = 1200 + MOTOR_OFFSET
PWM_BLUEROBOTICS_ESC_NEUTRAL: int = 1500 + MOTOR_OFFSET
PWM_BLUEROBOTICS_ESC_FORWARD: int = 2000 + MOTOR_OFFSET
...
CAMERA_IMAGE_WIDTH: int = 85 * 4
CAMERA_IMAGE_HEIGHT: int = 64 * 4
